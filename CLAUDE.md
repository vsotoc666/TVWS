...
| TRANSMISION (MAC/FEC/MOD/OFDM) | Fases 1-3 de software aprobadas, 15/15 pruebas (36/36 casos tras cerrar fragmentación TDD el 04/09/2026; FEC cerrado el 05/09/2026 — convolucional K=7 + puncturing para tasa 3/4, LDPC descartado), todo sin hardware SDR | Definir patrón de subportadoras piloto — accionable sin hardware, bloquea Fase 4, ver `claudedocs/riesgos_arquitectura_transmision.md` Problema 4. Fase 4 (hardware-in-the-loop) sigue bloqueada esperando el bladeRF del nodo Cliente | `TRANSMISION/pruebas/README.md` |
